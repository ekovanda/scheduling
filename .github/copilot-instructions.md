...
- **Testing**: Before completing a feature or fix review the relevant tests and suggest any missing ones. Prefer running targeted tests over broad, costly test suites.  
